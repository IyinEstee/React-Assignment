  ...
  function ToggleNavBar() {
    ...
    return (
      ...
      >
        ...
        <path
          fill="#fff"
          d="M86.8 1.4C76.4 17.5 60.3 32.3 43.7 31.9c-6.1-.1-13.1-1.9-19-6.7C20.3 21.6 15.9 16 14.2 8h-1.8c-2.7 0-4.3 2.4-4 4.6.1.5.2 1.1.3 1.7 1.3 7.8 5.9 16.6 13.6 22.3 6 4.4 13.4 7.3 21.5 7.3 14.6 0 30.2-9.3 43.8-33.2v-7c0-.8-.3-1.7-.8-2.3"
        ></path>
...
      </svg>
       <ul className="lg:flex hidden gap-7 font-bold">
                <li className="flex items-center gap-1 hover:text-[#00a2ff]">
                  Product <IoIosArrowForward className="text-xs mt-1"/></li>
                <li className="hover:text-[#00a2ff]">Pricing</li>
                <li className="flex items-center gap-1 hover:text-[#00a2ff]"
                >Resources <IoIosArrowForward className="text-xs mt-1"/></li>
       ...
       <ul className=" space-y-4 gap-10 font-bold">
                <li className="flex items-center gap-1 hover:text-[#00a2ff]">
                  Product <IoIosArrowDown className="text-xs mt-1"/></li>
                <li className="hover:text-[#00a2ff]">Pricing</li>
                <li className="flex items-center gap-1 hover:text-[#00a2ff]"
                >Resources <IoIosArrowDown className="text-xs mt-1"/></li>
                <li className="hover:text-[#00a2ff]">Book a demo</li>
            </ul>
       </nav>}
       </>
