...
const Examples = () => {
  return (
    <div className='p-20 flex gap-4'>
        <a className='bg-slate-100 border-4 hover:border-blue-400 rounded-xl p-10 text-left'>
         ...
         <a className='bg-slate-100 border-4 hover:border-blue-400 rounded-xl p-10 text-left'>
            ...
            <p className='lg:text-[24px] text-[14px] font-bold p-md-5'><span className='text-blue-400'>75% of all public <br />sales</span> from email<br/>autoresponders</p>
